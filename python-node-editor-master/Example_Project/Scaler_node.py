...
class Scaler_Node(Node):
    def __init__(self):
        ...
        self.title_text = "Scaler Int"
        self.type_text = "Constants"
        self.set_color(title_color=(255, 165, 0))

        self.add_pin(name="value", pintype="int", is_output=True)
        self.out_param = 3
    ...
    def init_widget(self):
        ...
        self.scaler_line.textChanged.connect(self.change_value)
    ...
    def change_value (self, text):
        ...
        myValue = int(text.replace(',', '.'))
        self.out_param = myValue
        print('attention', myValue, type(myValue))
